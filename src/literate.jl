...
\\0
#
#md # [![](https://img.shields.io/badge/show-nbviewer-579ACA.svg)](@__NBVIEWER_ROOT_URL__/examples/@__NAME__/notebook.ipynb)
#md #
# *You are seeing the
...
# [Julia source file](@__REPO_ROOT_URL__/$(examples_basedir)/@__NAME__/script.jl).
#md # The corresponding notebook can be viewed in [nbviewer](@__NBVIEWER_ROOT_URL__/examples/@__NAME__/notebook.ipynb).*
